...
**Caption:** Metrics of the linear regression fit of simulated nucleotide diversity as a function of time for each simulation scenario shown in panels in Figure Sx._
...
**Caption:** A schematic representation of a _slendr_ model used to simulate the effect of hunting on the beluga demographic history. The starting size of the population was always 40.000. The number of individuals removed from the population each generation due to hunting is indicated by each "step" decrease in population size._
